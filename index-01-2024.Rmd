...
```{r, include=FALSE}
library(readr)
martes <- as.Date ("2024-03-12")
viernes <- as.Date("2024-03-15")
...
### `r advdate(viernes, 4)`. Clase suspendida

### `r advdate(martes, 5)`. Unidad 3. La práctica - Migrantes
...
### `r advdate(viernes, 5)`. Unidad 3. La práctica - Situación de Calle
...
### `r advdate(viernes, 6)`. Unidad 3. La práctica -Niñeces

b. Salud Mental

-   CSJN, "R. M.J s/Insania", [aca](https://drive.google.com/file/d/1c29zw3cQDmwNGuO-GDR15KUq7Xc-UZJb/view?usp=sharing)

- Ley de salud mental [aca](https://servicios.infoleg.gob.ar/infolegInternet/anexos/175000-179999/175977/norma.htm)
...
c. Niñeces
  ...
  - MPT CABA, [Violencia contra Niños, Niñas y Adolescentes](https://drive.google.com/file/d/1lc3H955K8Wx1-7mdtDAJX--CBBcqXfuX/view?usp=sharing) (capítulos 1 y 2)



### `r advdate(martes, 7)`. Paro. Marcha Nacional universitaria
...
- Ley de Protección integral contra la Mujer [aca](http://servicios.infoleg.gob.ar/infolegInternet/anexos/150000-154999/152155/texact.htm) 
...
### `r advdate(martes, 8)`. Unidad 3. La práctica - LGBTIQ
...
### `r advdate(viernes, 8)`. Unidad 3. La práctica - Pueblos originarios
