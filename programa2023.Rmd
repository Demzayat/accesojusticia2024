...
```{r, include=FALSE}
library(readr)
martes <- as.Date ("2023-03-14")
viernes <- as.Date("2023-03-17")
...
### `r advdate(martes, 2)`. Clase suspendida por [Foro Mundial](https://fmdh23.org/programa/actividad/los-discursos-de-odio-como-afectacion-a-los-derechos-humanos/) 

### `r advdate(viernes, 2)`. Día de la Memoria. No hay clases


### `r advdate(martes, 3)` Unidad 1. Estándares internacionales
...
### + Unidad 2. Concepto clásico y estructural
...
### `r advdate(viernes, 3)`. Unidad 3. La Agenda estructural
...
### `r advdate(viernes, 4)`. No hay clases.
...
Unidad 3. La práctica

e.  Mujeres

- Pique, Fernandez Valle, "La garantía de imparcialidad judicial desde la perspectiva de género".
...
### `r advdate(viernes, 8)`. Unidad 3. La práctica
